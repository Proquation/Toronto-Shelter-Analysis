...
```{r}
# ARCH model (past shocks only)
garch_fit_1_0 <- garchFit(~garch(1, 0), data = corr_data_1, include.mean = TRUE, cond.dist = "norm")
resids_1_0 <- residuals(garch_fit_1_0)
plot(resids_1_0, type = "l", main = paste0("Residuals GARCH(1, 0) for room ", pairing_1), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "deeppink1")
#summary(garch_fit_1_0)

# Including both ARCH (past shocks) and GARCH (long term volatility)
garch_fit_1_1 <- garchFit(~garch(1, 1), data = corr_data_1, include.mean = TRUE, cond.dist = "norm")
resids_1_1 <- residuals(garch_fit_1_1)
plot(resids_1_1, type = "l", main = paste0("Residuals GARCH(1, 1) for room ", pairing_1), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "orchid4")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for room shelter-location ", pairing_1), 
     ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
resids_1_0 <- residuals(fit_2)
plot(resids_1_0, type = "l", main = paste0("Residuals GARCH(1, 0) for room ", pairing_2), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "deeppink1")
summary(fit_2)

fit_2.1 <- garchFit(~garch(1, 1), data = corr_data_2, include.mean = TRUE, cond.dist = "norm")
resids_1_1 <- residuals(fit_2.1)
plot(resids_1_1, type = "l", main = paste0("Residuals GARCH(1, 1) for room ", pairing_2), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "orchid4")
summary(fit_2.1)
```
...
plot(forecasted_em, main = paste0("EM with Kalman filter for room shelter-location ", pairing_2), 
     ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
resids_1_0 <- residuals(fit_3)

plot(resids_1_0, type = "l", main = paste0("Residuals GARCH(1, 0) for room ", pairing_3), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "deeppink1")
summary(fit_3)

fit_3.1 <- garchFit(~garch(1, 1), data = corr_data_1, include.mean = TRUE, cond.dist = "norm")
resids_1_1 <- residuals(fit_3.1)
plot(resids_1_1, type = "l", main = paste0("Residuals GARCH(1, 1) for room ", pairing_3), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "orchid4")
summary(fit_3.1)
```
...
plot(forecasted_em, main = paste0("EM with Kalman filter for room shelter-location ", pairing_3),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for room shelter-location ", pairing_4),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
resids_1_0 <- residuals(fit_5)
plot(resids_1_0, type = "l", main = paste0("Residuals GARCH(1, 0) for room ", pairing_5), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "deeppink1")
summary(fit_5)

fit_5.1 <- garchFit(~garch(1, 1), data = corr_data_1, include.mean = TRUE, cond.dist = "norm")
resids_1_1 <- residuals(fit_5.1)
plot(resids_1_1, type = "l", main = paste0("Residuals GARCH(1, 1) for room ", pairing_5), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "orchid4")
summary(fit_5.1)
```
...
plot(forecasted_em, main = paste0("EM with Kalman filter for room shelter-location ", pairing_5),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
resids_1_0 <- residuals(fit_1)
plot(resids_1_0, type = "l", main = paste0("Residuals GARCH(1, 0) for bed ", pairing_1_bed), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "deeppink1")
summary(fit_1)

fit_1.1 <- garchFit(~garch(1, 1), data = corr_data_1, include.mean = TRUE, cond.dist = "norm")
resids_1_1 <- residuals(fit_1.1)
plot(resids_1_1, type = "l", main = paste0("Residuals GARCH(1, 1) for bed ", pairing_1_bed), ylab = "Residuals", xlab = "Weeks (Starting Jan 2020)", col = "orchid4")
summary(fit_1.1)
```
...
plot(forecasted_em, main = paste0("EM with Kalman filter for bed shelter-location ", pairing_1_bed),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for bed shelter-location ", pairing_2_bed),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for bed shelter-location ", pairing_3_bed),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for bed shelter-location ", pairing_4_bed),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
...
plot(forecasted_em, main = paste0("EM with Kalman filter for bed shelter-location ", pairing_5_bed),
ylab = "Occupancy Rate", xlab = "Weeks (Starting Jan 2020)")
