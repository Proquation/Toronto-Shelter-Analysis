...
top_5_room_based_df = top_5_room_based_df %>%
  mutate(capacity_actual_sum = if_else(occupancy_rate > 1,
...
# Plotting the time series data for weekly averages of rooms
```{r}
...
# Plotting the time series data for weekly averages of beds
```{r}
